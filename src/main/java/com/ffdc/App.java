 ...
 * 1) Initialize config date
 * 2) Start BAD IP Screener  -- Store, persist and recognize bad IP address
 * 3) Starts Ingestor Deamon -- Ingest raw data in 5 min buckets in Aggregated Data
 * 4) Data Compressor -- Compress 5 min bucket date in 15 min bucket and 15 min bucket in 60 min
